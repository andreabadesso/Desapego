...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Amigo'
        db.create_table(u'Amigos_amigo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'Amigos', ['Amigo'])


    def backwards(self, orm):
        # Deleting model 'Amigo'
        db.delete_table(u'Amigos_amigo')
