...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Desapego.latitude'
        db.add_column(u'Desapegos_desapego', 'latitude',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Desapego.longitude'
        db.add_column(u'Desapegos_desapego', 'longitude',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Desapego.latitude'
        db.delete_column(u'Desapegos_desapego', 'latitude')

        # Deleting field 'Desapego.longitude'
        db.delete_column(u'Desapegos_desapego', 'longitude')
