...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Desapego.status'
        db.alter_column(u'Desapegos_desapego', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Status.Status'], null=True))

    def backwards(self, orm):

        # Changing field 'Desapego.status'
        db.alter_column(u'Desapegos_desapego', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Status.Status']))
