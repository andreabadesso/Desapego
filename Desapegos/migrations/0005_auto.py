...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field curtidas on 'Desapego'
        m2m_table_name = db.shorten_name(u'Desapegos_desapego_curtidas')
    ...
    def backwards(self, orm):
        # Removing M2M table for field curtidas on 'Desapego'
        db.delete_table(db.shorten_name(u'Desapegos_desapego_curtidas'))
    ...
    models = {
        ...
        u'Desapegos.desapego': {
            'Meta': {'ordering': "('created_at',)", 'object_name': 'Desapego'},
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'curtidas': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'curtiu'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['Usuarios.Usuario']"}),
