...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SugestaoUsuario'
        db.create_table(u'Hashtags_sugestaousuario', (
        ...
        db.send_create_signal(u'Hashtags', ['SugestaoUsuario'])


    def backwards(self, orm):
        # Deleting model 'SugestaoUsuario'
        db.delete_table(u'Hashtags_sugestaousuario')
    ...
    models = {
        ...
        u'Hashtags.sugestaousuario': {
            'Meta': {'object_name': 'SugestaoUsuario'},
            'fbId': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
